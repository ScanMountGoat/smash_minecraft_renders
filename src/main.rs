fn main() {
    ...
    let chara_3 =
        minecraft_render::create_rgba_from_png_raw(include_bytes!("../chara_3_pickel_00.png"));
    ...
    let chara_4 =
        minecraft_render::create_rgba_from_png_raw(include_bytes!("../chara_4_pickel_00.png"));
    ...
    let chara_6 =
        minecraft_render::create_rgba_from_png_raw(include_bytes!("../chara_6_pickel_00.png"));
